...
from bedrock_bridge.logging_utils import safe_error_message
...
def map_network_error(exc: Exception, operation_name: str) -> BedrockBridgeError:
    if isinstance(exc, BedrockBridgeError):
        return exc
