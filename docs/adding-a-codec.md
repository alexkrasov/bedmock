...
1. Create a module under `bedrock_bridge/codecs/`.
...
5. Register the codec in `bedrock_bridge/codecs/registry.py` or through the
`bedrock_bridge.codecs` entry point group.
